	...
	<div class="container">
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px;">
				<form method="post" action="joinAction_Stud.jsp">
					<h3 style="text-align: center;">회원가입(학생)</h3>
					<div class="form-group">
						<input type="text" class="form-control" placeholder="학번" name="userCode" maxlength="20">
					</div>
					<div class="form-group">
